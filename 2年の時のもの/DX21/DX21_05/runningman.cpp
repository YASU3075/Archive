...
void DrawRunningman(void)
{
	...
	double radian = g_degree * 180 / M_PI;

	trans = XMMatrixTranslation(300 * cos(radian) + SCREEN_WIDTH / 2, 300 * sin(radian) + SCREEN_HEIGHT / 2, 0.0f);
