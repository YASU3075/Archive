...
void InitPolygon(void)
{
	...
	g_Position.x = SCREEN_WIDTH / 2;
	g_Position.y = SCREEN_HEIGHT / 2;
...
void UpdatePolygon(void)
{
	...
	if (g_mouse.leftButton)
	{
		...
		g_Position.x = g_mouse.x;
		g_Position.y = g_mouse.y;
	}
